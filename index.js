...
const item1 = new Item(1, product1, user1, 2)
const item2 = new Item(2, product2, user1, 3)
const item3 = new Item(3, product3, user1, 1)

const cupon1 = new Cupon(1, 'DCF546')
const cupon2 = new Cupon(1, 'HGT657', 0.15)
const cupon3 = new Cupon(1, 'DWA098', 0.2)

const sc1 = new ShoppingCart(1, [item1, item2, item3], cupon3)
